...
public class DublinCoreTest {
    ...
    public void constructorCarriesvalues() throws Exception
    {
        ...
        ls.add( "contributor" );
        map.put( DublinCore.DublinCoreElement.CONTRIBUTOR, ls );
        ls = new ArrayList<String>();
        ls.add( "coverage" );
        map.put( DublinCore.DublinCoreElement.COVERAGE, ls );
        ls = new ArrayList<String>();
        ls.add( "creator" );
        map.put( DublinCore.DublinCoreElement.CREATOR, ls );
        ls = new ArrayList<String>();
        ls.add( setTimeAsString );
        map.put( DublinCore.DublinCoreElement.DATE, ls );
        ls = new ArrayList<String>();
        ls.add( "description" );
        map.put( DublinCore.DublinCoreElement.DESCRIPTION, ls );
        ls = new ArrayList<String>();
        ls.add( "format" );
        map.put( DublinCore.DublinCoreElement.FORMAT, ls );
        ls = new ArrayList<String>();
        ls.add( "language" );
        map.put( DublinCore.DublinCoreElement.LANGUAGE, ls );
        ls = new ArrayList<String>();
        ls.add( "publisher" );
        map.put( DublinCore.DublinCoreElement.PUBLISHER, ls );
        ls = new ArrayList<String>();
        ls.add( "relation" );
        map.put( DublinCore.DublinCoreElement.RELATION, ls );
        ls = new ArrayList<String>();
        ls.add( "rights" );
        map.put( DublinCore.DublinCoreElement.RIGHTS, ls );
        ls = new ArrayList<String>();
        ls.add( "source" );
        map.put( DublinCore.DublinCoreElement.SOURCE, ls );
        ls = new ArrayList<String>();
        ls.add( "subject" );
        map.put( DublinCore.DublinCoreElement.SUBJECT, ls );
        ls = new ArrayList<String>();
        ls.add( "title" );
        map.put( DublinCore.DublinCoreElement.TITLE, ls );
        ls = new ArrayList<String>();
        ls.add( "type" );
        ls.add( "second_type" );
        map.put( DublinCore.DublinCoreElement.TYPE, ls );
